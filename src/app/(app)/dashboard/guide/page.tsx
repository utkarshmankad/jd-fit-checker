...
const SITES = [
  ...
  'Ashby', 'Indeed', 'Rippling ATS', 'BambooHR',
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-5 space-y-5">
          <Step num={1} icon={MousePointer} title="Go to a company's jobs page">
            <p>Open the careers or jobs listing page of any company in your browser. Works on Greenhouse, Lever, Workday, Ashby, Indeed, and most custom career sites.</p>
          </Step>
