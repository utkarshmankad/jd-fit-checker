            ...
            {magicLinkSent ? (
              ...
              <form onSubmit={handleMagicLink} className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-lg font-medium text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  style={{ backgroundColor: '#1B3A5C' }}
                >
